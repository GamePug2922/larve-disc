...
module.exports = class {
    constructor() {
		this.language = {
			...
			REPORT_EXAMPLES: "$report @cute kitty#1444 Règles non respectées",
			// Errors
			...
			STATS_DESC: `${c.botname} est un Discord bot développé par ${c.owner.name} !`,
			...
			STATS_LINKS: (url, id) => `[Dashboard](${c.others.donate}) ● [Invite](https://discordapp.com/oauth2/authorize?client_id=${id}&scope=bot&permissions=2146958847) ● [Serveur](${url}) ● [Github](${c.others.github})`,
			// Headings
			STATS_HEADINGS:[
				`Stats`,
