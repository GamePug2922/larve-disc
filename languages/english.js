...
module.exports = class {
    constructor() {
		this.language = {
			...
			REPORT_EXAMPLES: "$report @cute kitty#1444 Breaking the rules",
			// Errors
			...
			LOVECALC_EXAMPLES: "$lovecalc @cute kitty#1444\n$lovecalc @cute kitty#1444 @Atlanta#6770",
			// Errors
			...
			REP_EXAMPLES: "$rep @cute kitty#1444",
			// Errors
			...
			ROB_EXAMPLES: "$rob @cute kitty#1444 100",
			// Errors
			...
			PAY_EXAMPLES: "$pay @cute kitty#1444 400",
			// Errors
			...
			WEDDING_EXAMPLES: "$wedding @cute kitty#1444",
			// Errors
			...
			STATS_DESC: `${c.botname} is an Discord bot developed by ${c.owner.name} !`,
			STATS_ONLINE: (time) => `From ${time}`,
			STATS_VC: (nb) => `Music in progress on \`${nb}\` servers`,
			STATS_CREDITS: `This bot is developed by ${c.owner.name}`,
			STATS_LINKS: (url, id) => `[Dashboard](${c.others.donate}) ● [Invite](https://discordapp.com/oauth2/authorize?client_id=${id}&scope=bot&permissions=2146958847) ● [Server](${url}) ● [Github](${c.others.github})`,
			// Headings
			STATS_HEADINGS:[
				`Stats`,
			...
			LOVE_EXAMPLES: "$love @cute kitty#1444\n$love @cute kitty#1444 @Clyde#0000",
			...
			BAN_EXAMPLES: "$ban @cute kitty#1444 Spam",
			// Errors
			...
			KICK_EXAMPLES: "$kick @cute kitty#1444 Spam",
			// Errors
			...
			MUTE_EXAMPLES: "$mute @cute kitty#1444 Spam",
			// Content
			...
			UNMUTE_EXAMPLES: "$unmute @cute kitty#1444",
			// Errors
			...
			SANCTIONS_EXAMPLES: "$sanctions @cute kitty#1444",
			// Errors
			...
			WARN_EXAMPLES: "$warn @cute kitty#1444 Spam",
			// Errors
			...
			CLEARSANCTIONS_EXAMPLES: "$clear-sanctions @cute kitty#1444",
			// Content
